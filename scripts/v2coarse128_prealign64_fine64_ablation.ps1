...
$cmmlocCoarse = Join-Path $root "coarsev1_batch128_epoch20_ablation_study\coarse_contN_epoch5_acc0.729_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update coarse(don't change just update name of folder with cmmlocpp_mncl_v2) # update:5
$mnclCoarse = Join-Path $root "cmmlocpp_mncl_v2\coarse_contN_epoch15_acc0.624_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update checkpoint name of coarse # update:6
$rerankCoarse = Join-Path $root "coarsev1_batch128_epoch20_ablation_study\coarse_contN_epoch5_acc0.729_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update:7
$fine = Join-Path $root "finev2_batch64_epoch45_ablation_study\fine_contN_epoch20_offset0.100_lr0.0003_obj-6-16_ecl0_eco0_p256_npa1_f-class-color-position-num.pth"
