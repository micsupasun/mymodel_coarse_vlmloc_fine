...
$cmmlocCoarse = Join-Path $root "cmmlocpp_mncl_v2\coarse.pth" # update coarse(don't change just update name of folder with cmmlocpp_mncl_v2) # update:5
...
$rerankCoarse = Join-Path $root "cmmlocpp_mncl_rerank_v1\coarse_contN_epoch6_acc0.788_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update:7
