...
$cmmlocCoarse = Join-Path $root "old\coarse_contN_epoch3_acc0.796_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update coarse(don't change just update name of folder with cmmlocpp_mncl_v2) # update:5
...
$rerankCoarse = Join-Path $root "old\coarse_contN_epoch3_acc0.796_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update:7
$fine = Join-Path $root "old\fine_contN_epoch41_offset0.103_lr0.0003_obj-6-16_ecl0_eco0_p256_npa1_f-class-color-position-num.pth"
