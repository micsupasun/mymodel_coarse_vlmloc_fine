...
$cmmlocCoarse = Join-Path $root "fine44\coarse_contN_epoch3_acc0.796_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update coarse(don't change just update name of folder with cmmlocpp_mncl_v2) # update:5
...
$rerankCoarse = Join-Path $root "fine44\coarse_contN_epoch3_acc0.796_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update:7
$fine = Join-Path $root "fine44\fine_contY_epoch44_offset0.108_lr0.0003_obj-6-16_ecl0_eco0_p256_npa1_f-class-color-position-num.pth"
