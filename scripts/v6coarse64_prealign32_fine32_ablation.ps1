...
$cmmlocCoarse = Join-Path $root "coarsev4_batch64_epoch20\coarse_contN_epoch4_acc0.797_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update coarse(don't change just update name of folder with cmmlocpp_mncl_v2) # update:5
$mnclCoarse = Join-Path $root "coarsev4_batch64_epoch20\coarse_contN_epoch4_acc0.797_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update checkpoint name of coarse # update:6
$rerankCoarse = Join-Path $root "coarsev4_batch64_epoch20\coarse_contN_epoch4_acc0.797_ecl0_eco0_p256_npa1_loss-contrastive_f-class-color-position-num.pth" # update:7
