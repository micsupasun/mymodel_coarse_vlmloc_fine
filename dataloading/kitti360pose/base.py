...
from dataloading.kitti360pose.compat import load_kitti360pose_pickle
...
class Kitti360BaseDataset(Dataset):
    def __init__(self, base_path, scene_name):
        ...
        self.cells = load_kitti360pose_pickle(
            osp.join(base_path, "cells", f"{scene_name}.pkl")
        ...
        self.poses = load_kitti360pose_pickle(
            osp.join(base_path, "poses", f"{scene_name}.pkl")
        )
